          ...
          <SecondaryWrap>
            <Box>
              <Title secondary>Ingredients</Title> {
                ...
                { return (<div><Modify x href="#" onClick={this.deleteField} name="ingredients" id={i}>x</Modify> <Input type="text" id={i} name="ingredients" value={ingredient} style={{ height: "auto" }} onChange={this.handleChange} /></div>) })}
              <Modify href="#" onClick={this.addField} name="ingredients">+</Modify>
            </Box>
            <Box>
              <Title secondary>Directions</Title> {
                recipe.directions.map((direction, i) =>
                { return (<div><Modify x href="#" onClick={this.deleteField} name="directions" id={i}>x</Modify>  <TextArea type="text" id={i} name="directions" value={direction} onChange={this.handleChange} /></div>) })
              }
